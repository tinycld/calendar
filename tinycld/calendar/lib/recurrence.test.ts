...
describe('parseRRule', () => {
    it('parseRRule: full RRULE string', () => {
...
describe('generateOccurrences: DAILY', () => {
    it('daily: occurrence on each day in range', () => {
...
describe('every weekday', () => {
    it('daily + BYDAY: every weekday (Mon-Fri)', () => {
...
describe('generateOccurrences: WEEKLY', () => {
    it('weekly: same day of week as event start', () => {
    ...
    it('weekly + BYDAY: only matching days', () => {
    ...
    it('weekly + INTERVAL=2: every other week', () => {
        const start = new Date(2026, 3, 6, 10, 0) // Monday
...
describe('generateOccurrences: MONTHLY', () => {
    it('monthly: by day of month (default)', () => {
    ...
    it('monthly BYMONTHDAY with a day before eventStart: no month dropped', () => {
    ...
    it('monthly by weekday position: BYDAY=1MO (first Monday)', () => {
    ...
    it('monthly by weekday position: BYDAY=2TU (second Tuesday)', () => {
...
describe('Range edge cases', () => {
    it('event start before range: forward occurrences still emitted', () => {
    ...
    it('event after range: no occurrences', () => {
...
describe('expandRecurringEvents', () => {
    it('expandRecurringEvents: non-recurring pass through', () => {
    ...
    it('expandRecurringEvents: non-recurring outside range excluded', () => {
    ...
    it('expandRecurringEvents: daily recurrence creates multiple occurrences', () => {
    ...
    it('expandRecurringEvents: all-day recurring events', () => {
    ...
    it('expandRecurringEvents: all-day recurring occurrences do not shift TZ (regression)', () => {
    ...
    it('expandRecurringEvents: safety cap', () => {
        const event = makeEvent(
            'e1',
            '2026-04-01T10:00:00.000Z',
            '2026-04-01T11:00:00.000Z',
...
describe('Composite IDs', () => {
    it('composite IDs: unique and parseable', () => {
        const event = makeEvent(
            'abc123',
            '2026-04-01T10:00:00.000Z',
            '2026-04-01T11:00:00.000Z',
    ...
    it('parseEventId: non-composite ID', () => {
...
describe('describeRRule', () => {
    ...
    it('describeRRule: empty string', () => {
        const desc = describeRRule('', new Date(2026, 3, 5))
        assert.equal(desc, '')
    })
})

describe('getContextualPresets', () => {
    it('getContextualPresets: generates correct presets for a Monday', () => {
    ...
    it('All recurrence tests passed!', () => {})
})
