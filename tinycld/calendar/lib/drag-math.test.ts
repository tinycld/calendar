...
describe('resizeEnd', () => {
    ...
    it('end is clamped to the grid bottom (end of day)', () => {
...
describe('moveEvent', () => {
    it('+60px shifts start and end by an hour, duration preserved', () => {
        const e = makeEvent(9, 0, 10, 0)
    ...
    it('dragging above the grid top clamps the start, keeps duration', () => {
    ...
    it('deltaDays shifts the calendar date, preserving time-of-day', () => {
