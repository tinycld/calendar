...
describe('layoutTimedEvents', () => {
    ...
    it('two overlapping events get side-by-side columns', () => {
    ...
    it('expand-to-fill: short event expands into empty columns', () => {
    ...
    it('filters out zero-duration events', () => {
...
describe('layoutAllDayEvents', () => {
    it('single all-day event on first day', () => {
    ...
    it('multi-day event spans correct columns', () => {
    ...
    it('overlapping all-day events go to different rows', () => {
    ...
    it('non-overlapping all-day events share a row', () => {
    ...
    it('clips events to visible week range', () => {
...
describe('layoutMonthEvents', () => {
    it('single timed event appears in correct cell', () => {
    ...
    it('multi-day event spans across cells', () => {
    ...
    it('overflow count works with maxVisible', () => {
        const events = [
            makeEvent('a', 9, 10),
            makeEvent('b', 10, 11),
            makeEvent('c', 11, 12),
    ...
    it('multi-day events get isAllDay=true, single-day get isAllDay=false', () => {
    ...
    it('isStart is true only on the starting cell', () => {
        const events = [makeAllDayEvent('a', 1, 3)]
        const result = layoutMonthEvents(events, weekStart, 5)
        const cell1 = result.get(1)!
        const cell2 = result.get(2)!
    ...
    it('empty input returns cells with empty layouts', () => {
